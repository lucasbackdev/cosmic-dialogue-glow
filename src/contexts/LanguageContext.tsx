...
const translations = {
  "pt-BR": {
    ...
    googleAdsDesc: "Insira o ID da conta Google Ads (formato: 123-456-7890). Uma solicitação de vinculação será enviada para o proprietário da conta aceitar.",
    currentAccount: "Conta atual",
    sendLinkRequest: "Enviar solicitação de vinculação",
    sendingRequest: "Enviando solicitação...",
    afterSending: "Após enviar, o proprietário da conta precisará aceitar o convite no Google Ads.",
    language: "Idioma",
  ...
  en: {
    ...
    // Settings
    googleAds: "Google Ads",
    googleAdsDesc: "Enter your Google Ads account ID (format: 123-456-7890). A linking request will be sent to the account owner to accept.",
    currentAccount: "Current account",
    sendLinkRequest: "Send linking request",
    sendingRequest: "Sending request...",
    afterSending: "After sending, the account owner will need to accept the invite in Google Ads.",
    language: "Language",
